# Docker Cloud Security Skill Error Model

**File:** `skills/cloud/docker/error-model.md`
...
This document defines the canonical error categories of the Docker Cloud Security Skill and
...
|----------|---------|---------|
| out-of-scope | Engine or resource outside Scope | rejected |
...
| metadata-unavailable | Engine metadata could not be collected | partial |
...
When the Container Client cannot collect metadata, affected checks SHALL be partial.
