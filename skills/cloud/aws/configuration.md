# AWS Cloud Security Skill Configuration

**File:** `skills/cloud/aws/configuration.md`
...
This document defines the declarative configuration of the AWS Cloud Security Skill and
