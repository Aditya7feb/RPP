# AWS Cloud Security Skill Error Model

**File:** `skills/cloud/aws/error-model.md`
...
This document defines the canonical error categories of the AWS Cloud Security Skill and
...
|----------|---------|---------|
| out-of-scope | Account or resource outside Scope | rejected |
...
When read credentials are not provided, affected checks SHALL be reported as not
performed rather than guessed.

---

# metadata-unavailable

When the AWS or Cloud Storage client cannot collect metadata, affected checks SHALL be
partial.
