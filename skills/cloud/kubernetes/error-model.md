# Kubernetes Cloud Security Skill Error Model

**File:** `skills/cloud/kubernetes/error-model.md`
...
This document defines the canonical error categories of the Kubernetes Cloud Security Skill
...
|----------|---------|---------|
| out-of-scope | Namespace or resource outside Scope | rejected |
...
| metadata-unavailable | Cluster metadata could not be collected | partial |
...
When the Kubernetes Client cannot collect metadata, affected checks SHALL be partial.
