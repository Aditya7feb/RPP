# GCP Cloud Security Skill Interface

**File:** `skills/cloud/gcp/interface.md`
...
This document defines the stable, implementation-independent interface of the GCP Cloud
...
The skill exposes a single logical operation, `assess`, that evaluates GCP security
...
read credentials by reference only. `options` toggle individual analyses and default to
...
- No out-of-scope project SHALL have been assessed.
