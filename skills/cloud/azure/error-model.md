# Azure Cloud Security Skill Error Model

**File:** `skills/cloud/azure/error-model.md`
...
This document defines the canonical error categories of the Azure Cloud Security Skill
...
|----------|---------|---------|
| out-of-scope | Subscription or resource outside Scope | rejected |
...
When the Azure or Cloud Storage client cannot collect metadata, affected checks SHALL be
partial.
