# Azure Cloud Security Skill Configuration

**File:** `skills/cloud/azure/configuration.md`
...
This document defines the declarative configuration of the Azure Cloud Security Skill and
...
`max_resources` bounds the number of resources interpreted per assessment. The skill
SHALL NOT exceed this bound.
