# Azure Cloud Security Skill Execution

**File:** `skills/cloud/azure/execution.md`
...
This document defines the deterministic execution model of the Azure Cloud Security
Skill, stage by stage. Given the same observed metadata and configuration, execution
...
[Scope](../../../schemas/scope.md). Out-of-scope subscriptions SHALL be rejected before
any action.
...
[Azure Client](../../shared/azure-client/README.md) and storage exposure metadata through
the [Cloud Storage Client](../../shared/cloud-storage-client/README.md). Collection is
...
The skill SHALL interpret Entra ID role assignments and effective permissions and record
...
The skill SHALL interpret service configuration and defaults and record insecure settings
as Observations classified CWE-1188.
