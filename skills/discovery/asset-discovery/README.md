...
- [Endpoint Enumeration](../endpoint-enumeration/README.md) produces or enriches
  ...
  parameter mining.
- Asset Discovery is the canonical authority for consolidating and deduplicating
  `endpoint` Assets across all sources and introduces no new `endpoint` Assets of
  its own.
