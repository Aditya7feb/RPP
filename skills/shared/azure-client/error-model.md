# Azure Client Error Model

**File:** `skills/shared/azure-client/error-model.md`
...
This document defines the canonical error categories of the Azure Client Shared Skill and
...
|----------|---------|---------|
| out-of-scope | Subscription, resource group, region, or service outside scope | rejected |
...
retry through the [Retry](../retry/README.md) shared skill; persistent failure SHALL yield
a partial result.
