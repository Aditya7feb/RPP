...
**File:** `skills/web-security/cors/interface.md`
...
This document defines the stable, implementation-independent interface of the CORS
...
- `test_origins` (optional) — the untrusted origins used to probe reflection.
...
- Observe cross-origin behavior through the shared HTTP Client
