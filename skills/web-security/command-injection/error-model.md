# Command Injection Error Model

**File:** `skills/web-security/command-injection/error-model.md`
...
This document defines the canonical error categories of the Command Injection Skill
...
Raised when a required action returns `requires_approval`, as command injection
testing commonly does.
...
- Never run harmful commands in response to an error
