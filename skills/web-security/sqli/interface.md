...
**File:** `skills/web-security/sqli/interface.md`
...
This document defines the stable, implementation-independent interface of the SQL
Injection Skill. Consumers depend only on this contract.
...
- Bound time-based probe delays and never extract or alter data
