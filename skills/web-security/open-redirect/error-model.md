# Open Redirect Error Model

**File:** `skills/web-security/open-redirect/error-model.md`
...
This document defines the canonical error categories of the Open Redirect Skill and
...
- Never follow a redirect into a harmful destination in response to an error
- Never weaken policy constraints in response to an error
- Redact sensitive tokens in all error evidence
