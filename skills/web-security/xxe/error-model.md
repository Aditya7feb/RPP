# XML External Entity Error Model

**File:** `skills/web-security/xxe/error-model.md`
...
This document defines the canonical error categories of the XML External Entity Skill
...
Raised when a required action returns `requires_approval`, as XXE testing commonly
does.
...
Raised when an entity probe cannot be delivered to a specific XML endpoint.
