# Insecure Direct Object Reference Error Model

**File:** `skills/web-security/idor/error-model.md`
...
This document defines the canonical error categories of the Insecure Direct Object
Reference Skill and their mapping to outcomes. Errors are classified deterministically
so consumers can respond consistently.
...
Raised when a controlled test identity cannot be established for cross-identity
testing.
...
- Never enumerate or exfiltrate other principals' data in response to an error
