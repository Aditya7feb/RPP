# Server-Side Template Injection Error Model

**File:** `skills/web-security/ssti/error-model.md`
...
This document defines the canonical error categories of the Server-Side Template
Injection Skill and their mapping to outcomes. Errors are classified deterministically
...
Raised when a required action returns `requires_approval`, as template injection
...
- Never escalate to code execution in response to an error
