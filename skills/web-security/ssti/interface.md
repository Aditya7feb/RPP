# Server-Side Template Injection Interface

**File:** `skills/web-security/ssti/interface.md`
...
Server-Side Template Injection Skill. Consumers depend only on this contract.
...
- `payload_set_ref` (optional) — a reference to a managed set of bounded expression
  markers. It SHALL be a reference, never inline code-execution payloads.
...
- Inject bounded expression markers and observe evaluation through the shared HTTP
  Client
- Confirm evaluation without escalating to code execution
