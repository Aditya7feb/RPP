# Content Security Policy Error Model

**File:** `skills/web-security/csp/error-model.md`
...
This document defines the canonical error categories of the Content Security Policy
