...
**File:** `skills/web-security/csp/interface.md`
...
Content Security Policy Skill. Consumers depend only on this contract.
...
- Observe the Content Security Policy through the shared HTTP Client
