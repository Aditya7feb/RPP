# Path Traversal Error Model

**File:** `skills/web-security/path-traversal/error-model.md`
...
This document defines the canonical error categories of the Path Traversal Skill and
...
Raised when a traversal probe cannot be delivered to a specific path parameter.
...
- Never read or exfiltrate sensitive files in response to an error
