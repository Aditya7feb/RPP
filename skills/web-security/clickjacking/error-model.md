# Clickjacking Error Model

**File:** `skills/web-security/clickjacking/error-model.md`
...
This document defines the canonical error categories of the Clickjacking Skill and
