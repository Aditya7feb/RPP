# Clickjacking Interface

**File:** `skills/web-security/clickjacking/interface.md`
...
Clickjacking Skill. Consumers depend only on this contract.
...
```
assess_clickjacking(request) → result
```
...
- Observe framing controls through the shared HTTP Client
