# OAuth2 Authentication Error Model

**File:** `skills/authentication/oauth2/error-model.md`
...
This document defines the canonical error categories of the OAuth2 Authentication
...
Raised when an OAuth2 flow cannot be completed far enough to evaluate a specific
check.

- Outcome — `partial`
- Action — evaluate remaining checks; record the failure
...
| Flow Error | partial | No | Observation ref |
...
- Redact tokens and client secrets in all error evidence
