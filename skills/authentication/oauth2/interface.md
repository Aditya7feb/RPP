...
**File:** `skills/authentication/oauth2/interface.md`
...
OAuth2 Authentication Skill. Consumers depend only on this contract.
...
- `target` (required) — an in-scope OAuth2 authorization server or client
...
- `evidence` — [Evidence](../../../schemas/evidence.md) references, tokens and
...
- Observe OAuth2 flows through the shared HTTP Client
- Record Observations and promote Evidence with tokens and client secrets redacted
