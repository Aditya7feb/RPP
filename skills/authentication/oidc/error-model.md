# OIDC Authentication Error Model

**File:** `skills/authentication/oidc/error-model.md`
...
This document defines the canonical error categories of the OIDC Authentication
...
Raised when an OIDC flow cannot be completed far enough to evaluate a specific
check.
...
- Redact ID tokens and secrets in all error evidence
