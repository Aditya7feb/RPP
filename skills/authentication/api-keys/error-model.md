# API Key Authentication Error Model

**File:** `skills/authentication/api-keys/error-model.md`
...
This document defines the canonical error categories of the API Key Authentication
...
- Redact key material in all error evidence
