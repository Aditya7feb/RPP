# Session Management Error Model

**File:** `skills/authentication/sessions/error-model.md`
...
This document defines the canonical error categories of the Session Management
...
Raised when managed credentials fail to reach an authenticated session state.
...
- Redact session identifiers and secrets in all error evidence
