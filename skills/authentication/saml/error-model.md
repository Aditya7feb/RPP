# SAML Authentication Error Model

**File:** `skills/authentication/saml/error-model.md`
...
This document defines the canonical error categories of the SAML Authentication
...
Raised when a provided test assertion is malformed or cannot be prepared.

- Outcome — `partial`
- Action — evaluate assertion-independent checks; record the failure
- Evidence — the failed observation reference, material redacted
...
| Assertion Error | partial | No | Observation ref |
...
- Redact assertions and signing material in all error evidence
