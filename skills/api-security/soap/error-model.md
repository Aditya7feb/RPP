# SOAP API Security Error Model

**File:** `skills/api-security/soap/error-model.md`
...
This document defines the canonical error categories of the SOAP API Security Skill
