# REST API Security Error Model

**File:** `skills/api-security/rest/error-model.md`
...
This document defines the canonical error categories of the REST API Security Skill
